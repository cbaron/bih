...
function program1(depth0,data) {
  ...
  buffer += "\n                    <div class=\"option-row\">\n                        <div class=\"image col-md-5 col-sm-5 col-xs-5\">\n                            <img src=\""
    ...
    + "\"/>\n                        </div>\n                        <div class=\"detail col-md-7 col-sm-7 col-xs-7\">\n                            <div class=\"header\">\n                                <span class=\"name col-md-9 col-sm-9 col-xs-9\">";
  if (helper = helpers.name) { stack1 = helper.call(depth0, {hash:{},data:data}); }
  else { helper = (depth0 && depth0.name); stack1 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data}) : helper; }
  buffer += escapeExpression(stack1)
    + "</span>\n                                <button data-id=\""
    + escapeExpression(((stack1 = (depth0 && depth0.id)),typeof stack1 === functionType ? stack1.apply(depth0) : stack1))
    + "\" data-js=\"selectBtn\" class=\"select-btn col-md-3 col-sm-3 col-xs-3\">SELECT</button>\n                            </div>\n                            <div class=\"rules\">";
